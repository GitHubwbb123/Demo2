...
void userHandle(void)
{
    ...
    currentDataPoint.valueDI1 =(P1IN&BIT1) ;//Add Sensor Data Collection
    currentDataPoint.valueDI2 =(P1IN&BIT2);//Add Sensor Data Collection
    currentDataPoint.valueDI3 =(P1IN&BIT3);//Add Sensor Data Collection
    ...
    */
    currentDataPoint.valueAI1 =80 ;//Add Sensor Data Collection
    currentDataPoint.valueAI2 =30;//Add Sensor Data Collection
    /*
